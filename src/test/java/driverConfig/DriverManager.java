    	    ...
    	    switch (nav) {
    	       case Chrome:
				...
				if (os.contains("linux")){
					...
					System.out.println(System.getProperty("user.name")+"/src/test/java/driver/chromedriver");
					System.setProperty("webdriver.chrome.driver",System.getProperty("user.name")+"Framework_Automatizacion_standard/src/test/java/driver/chromedriver");
